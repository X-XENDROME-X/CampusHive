 ...
 *
 * <p> Description: This class manages the OTP generation and verification for 
 * the user password reset process, including sending OTP emails and changing the password. </p>
 *
