...
public class GenericMessagesController {
    ...
    private void loadMessages() throws SQLException {
        ...
        String[][] messageData = {
            {"STU001", "2024-11-15 10:30", "Navigation Help", "Need help with navigation"},
            {"STU002", "2024-11-14 15:45", "Login Issues", "Cannot login to account"},
            {"STU003", "2024-11-14 09:15", "Search Function", "Search not working"},
            {"STU004", "2024-11-13 14:20", "Profile Update", "Unable to update profile"}
        };
